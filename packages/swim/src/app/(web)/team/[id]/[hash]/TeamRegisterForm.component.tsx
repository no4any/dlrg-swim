...
import teamRegisterAction from "./teamRegister.action"
import { useFormState } from "react-dom"
import { z } from "zod"

export interface TeamRegisterFormState {
    checkInput?: boolean,
...
export interface TeamRegisterFormProps {
    id: string,
    hash: string
}

export default function TeamRegisterForm({id, hash}: TeamRegisterFormProps) {
    const [state, formAction] = useFormState<TeamRegisterFormState, FormData>(teamRegisterAction, {})
